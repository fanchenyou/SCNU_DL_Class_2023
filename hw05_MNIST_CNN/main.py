...
def main():
    ...
    parser.add_argument('--type', type=str, default='SGD', choices=['SGD', 'ADAM', 'MyADAM'],
    ...
    elif args.type == 'MyADAM':
        from adam_TODO import MyADAMOptimizer
        optimizer = MyADAMOptimizer(model.parameters(), lr=args.lr)
    else:
    ...
    # compare SGD, ADAM, MyADAM convergence and explain which and why is better
